...
python3 maqp.py --generate_hdf --generate_sampled_hdfs --generate_ensemble --ensemble_path ../../../train-test-data/forest_power-data-sql/ --version power --csv_seperator ';'
python3 maqp.py --evaluate_cardinalities --rdc_spn_selection --max_variants 1 --pairwise_rdc_path ../imdb-benchmark/spn_ensembles/pairwise_rdc.pkl --dataset imdb-ranges --target_path ../../../train-test-data/forest_power-data-sql/powertest.sql.deepdb.results.csv --ensemble_location ../../../train-test-data/forest_power-data-sql/power.sql.deepdb.model.pkl --query_file_location ../../../train-test-data/forest_power-data-sql/powertest.sql --ground_truth_file_location ../../../train-test-data/forest_power-data-sql/powertest.sql.csv --version power

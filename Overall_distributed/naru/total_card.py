...
mee_1, met_1, latency_1 = get_card('./power_1.result.csv')
mee_2, met_2, latency_2 = get_card('./power_2.result.csv')
mee_3, met_3, latency_3 = get_card('./power_3.result.csv')

fmetric = open('./power.naru_distributed.txt', 'a')

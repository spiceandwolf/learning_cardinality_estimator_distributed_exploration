...
if __name__ == '__main__':
    ...
    # ai4db
    parser.add_argument('--database_name', default='ai4db')
    # ai4db
    ...
    # Evaluetime
        ...
        # ai4db
        # Read pre-trained ensemble and evaluate cardinality queries
        from evaluation.cardinality_evaluation import evaluate_distributed_cardinalities
        logging.info(
            f"maqp(evaluate_distributed_cardinalities: database_name={args.database_name}, target_path={args.target_path})")
        evaluate_distributed_cardinalities(args.version, args.ensemble_location, args.database_name, args.query_file_location,
                               args.target_path,
                               schema, args.rdc_spn_selection, args.pairwise_rdc_path,
                               use_generated_code=args.use_generated_code,
                               merge_indicator_exp=args.merge_indicator_exp,

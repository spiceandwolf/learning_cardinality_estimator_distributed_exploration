"""参考deepdb的graph_representation.py"""
...
class Query:
    ...
    def get_query_str(self):
        full_join_query = self.gen_full_join_query(self.schema_graph, self.relationship_set, self.table_set, "JOIN")

        where_cond = self.print_conditions(self.conditions, seperator='AND')
        if where_cond != "":
